...
<body>
    ...
    <div class="main-content">
    	<h1>Welcome</h1>
        <h2>List of Zipcode:</h2>
  <h2>Zipcodes for area: ${areaName}</h2>

<% 
    java.util.List<Integer> zipcodes = (java.util.List<Integer>) request.getAttribute("zipcodes");
...
%>
    <p style="color: red;">No zip codes found for this area.</p>
<% 
    } 
%>
